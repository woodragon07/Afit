...
# Blueprint 임포트
from routes import recommendation_page_routes, recommendations, auth_routes, product_routes, bookmark_routes, chatrecommendation_routes, shopping_secretary_routes
